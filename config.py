...
#Database 
DB_URI = "mongodb+srv://dbadminanurag:dbadmin2001@cluster0.lvsel.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
...
try:
    ADMINS=[]
    for x in (os.environ.get("ADMINS", "1972746150").split()):
        ADMINS.append(int(x))
except ValueError:
